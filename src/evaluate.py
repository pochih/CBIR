# pylint: disable=invalid-name,missing-docstring,exec-used,too-many-arguments,too-few-public-methods,no-self-use,too-many-return-statements,too-many-locals
...
def infer(query, samples=None, db=None, sample_db_fn=None, depth=None, d_type='d1'):
    ...
    '''
    assert samples is not None or (db is not None and sample_db_fn is not
